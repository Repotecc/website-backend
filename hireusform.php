...
<?php 
    ...
    if ($_SERVER['REQUEST_METHOD'] === "POST") { 
        ...
        if (empty($errors)) {
            ...
            $mail->Host = "email-smtp.eu-west-2.amazonaws.com";                    // Specify main and backup SMTP servers
            $mail->SMTPAuth = true;                            // Enable SMTP authentication
            $mail->Username = "AKIA3GXMZZ4ETNFBSDOL";          // SMTP username
            $mail->Password = "BGznd9n00GEC/HQW0ROCwfQs3PQ3YJm3iPJmM+hcwB+K"; // SMTP password
